...
def formatRecvdData(data_recvd):
	...
	if 'Invalid' in data_recvd:
		print("\033[5;31m"+data_recvd+" \033[0m")
	elif '<<<' in data_recvd:
		print("\033[1;32m"+data_recvd+" \033[0m")
	elif '>>>' in data_recvd:
		print("\033[1;33m"+data_recvd+" \033[0m")
	elif '━━━━' in data_recvd:
		print("\033[3;36m"+data_recvd+" \033[0m")
	else:
		print("\033[1;35m"+data_recvd+" \033[0m")
